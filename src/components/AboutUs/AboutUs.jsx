...
const AboutUs = () => {
    ...
    let currentDisplay, maximumWidth;
    ...
    return (
        ...
        <div className={classes.root} >
            ...
            <Grid md={12} lg={6} item style={{maxWidth: maximumWidth, paddingLeft: '50px', textAlign:'justify'}}>

                <Typography variant='h6' style={{color: 'white'}}>ABOUT US</Typography>

                <Typography className='allText' variant='body1' component='p' style={{width: maximumWidth, display: 'inline-block'}}>
                ...
                <Typography variant='body1' component='p' style={{width: maximumWidth}}>
